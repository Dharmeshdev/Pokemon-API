...
function getPokemonHtml(aPokemon) {
    return `
        <div class="a-pokemon">
            ...
            <div class="a-pokemon-lang">Japanese ${aPokemon.name.japanese}</div>
            <div class="a-pokemon-lang">Chinese: ${aPokemon.name.chinese}</div>
            <div class="a-pokemon-lang">French: ${aPokemon.name.french}</div>
        </div>
    `
}
